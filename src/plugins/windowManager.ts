...
interface AppWindow {
    title?: string;
    component: 'CliScriptView' | 'ErrorNotFound' | 'GetToken' | 'Home' | 'IllustDetailLocal' | 'IllustDetailPixiv' | 'IllustQueryLocal' | 'PixivSearchIllust' | 'PixivSearchUser' | 'PixivUserDetail' | 'RepoView' | 'TrendingTags';
    props?: object;
}
/** 自动生成 Interface End */
